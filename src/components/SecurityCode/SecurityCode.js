...
export default class Verificode extends Component {
...
// class Verificode extends Component {
  ...
  refreshCanvas(){
    ...
    if (canvas.getContext) {
      ...
      for(let i = 0; i <4; i++) {
        ctx.font = '60px Calibri'; //随机生成字体大小
  ...
  render() {
    ...
    return (
      <div className='vcodewrap' style={ownStyle}>
        <canvas id="bgi"  style={{width:'150px',height:'50px'}}ref={this.canvas} onMouseEnter={() => this.setState({refresh:true})}></canvas>
